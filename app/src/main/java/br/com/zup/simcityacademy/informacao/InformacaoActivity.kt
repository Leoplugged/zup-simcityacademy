...
class InformacaoActivity : AppCompatActivity() {
    //TODO [OK] lógica para vincular as view
    ...
    //TODO [OK] Lógica para recuperar dados
    private fun recuperarExibirDados() {
        /**
         * Recuperando o objeto que está chegando a partir da intent nesse caso usamos
         * getParcelableExtra por que é o tipo de dado que vamos recuperar da intent e entre os
         * sinais de < e > passamos a classe que queremos definir o tipo do nosso objeto
    ...
    //TODO [OK] Lógica de exibição de dados
    private fun exibirNomeAlune(nome: String) {
        binding.tvNomeAlune.text = nome
    }

    //TODO [OK] Lógica do cálculo da média
    ...
    //TODO [OK] Lógica de exibição da média
    ...
    //TODO [OK] Lógica de exibição da mensagem
